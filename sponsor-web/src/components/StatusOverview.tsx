...
import type { CdkRedeemResponse, EntitlementStatus, MeResponse } from "@/lib/types"
...
export interface StatusOverviewProps{me:MeResponse;onRedeemed?: (result: CdkRedeemResponse) => void}
export function StatusOverview({me,onRedeemed}:StatusOverviewProps){
 ...
 return <div className="grid gap-6">
  ...
  <CdkRedeemPanel onRedeemed={onRedeemed}/>
  <UsageHeatmap/>
 </div>
}
